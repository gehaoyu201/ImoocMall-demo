<template>
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <span class="navbar-link" v-text="userName" v-if="nickName"></span>
          <a
            href="javascript:void(0)"
            class="navbar-link"
            @click="showLogin=true,showOverLay=true"
            v-if="!nickName"
          >Login</a>
          <a href="javascript:void(0)" class="navbar-link" v-if="nickName" @click="logOut">Logout</a>
          <div class="navbar-cart-container">
            <span class="navbar-cart-count" v-if="cartCount>0">已添加购物车{{cartCount}}件商品</span>
    ...
    <div class="md-modal modal-msg md-modal-transition md-show" v-if="showLogin">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">Login in</div>
          <button class="md-close" @click="showLogin=false,showOverLay=false">Close</button>
        </div>
    ...
    <div class="md-overlay" v-if="showOverLay" @click="showOverLay=false,showLogin=false"></div>
  </header>
</template>
