<template>
  ...
  <div class="container">
            ...
            <li v-for="item in cartList">
              ...
              <div class="cart-tab-5">
                <div class="cart-item-opration">
                  <a href="javascript:;" class="item-edit-btn" @click="showMdConfirm(item.productId)">
    ...
    <modal v-bind:mdShow="mdConfirm" @close="closeCartConfirm">
      <p slot="message">你确认要删除此条数据吗？</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delCart">确认</a>
        <a class="btn btn--m" href="javascript:;" @click="mdConfirm=false">关闭</a>
      </div>
    </modal>
    ...
    export default {
        ...
        methods:{
            ...
            delCart(){
                ...
                console.log(param)
                axios.post("/users/cartDel",param).then((response)=>{
                    let res = response.data;
                    if(res.status == '0'){
                        this.mdConfirm = false;
            ...
            toggleCheckAll(){
                ...
                axios.post('/users/cartAll',param).then((response)=>{
                   let res = response.data;
                });
            },
            checkOut(){
