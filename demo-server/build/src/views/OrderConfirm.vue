...
<!--            <button class="btn btn&#45;&#45;m" @click="">Previous</button>-->
...
<!--            <router-link to="/payment" class="btn btn&#45;&#45;m" @click="payment">Proceed to payment</router-link>-->
          </div>
        </div>
      </div>
    </div>
    ...
    export default {
        ...
        methods:{
            ...
            payment(){
                ...
                axios.post("/users/payment",param).then((response)=>{
                    let res = response.data;
                    if(res.status == '0'){
                        this.$router.push({
